...
function M.start (baseLink, leaderboardKey, leaderBoardCount)
	...
	local backBtn = displayNewButton(group, "scoredojo/buttonUpSmall.png", "scoredojo/buttonDownSmall.png", 20, -3, false, 1, nil, "menu", "Back", 25, 25, 25, "DimitriSwank", 40, removeFields, nil)
	--------------
	--functions
	--------------
